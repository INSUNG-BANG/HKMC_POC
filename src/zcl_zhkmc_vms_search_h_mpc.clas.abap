class ZCL_ZHKMC_VMS_SEARCH_H_MPC definition
  public
...
TT_MATERIAL type standard table of TS_MATERIAL .
  ...
  begin of TS_SOLDTOPARTY,
     ...
     KUNNR type KUNNR,
     LOEVM type LOEVM_X,
  end of TS_SOLDTOPARTY .
  types:
TT_SOLDTOPARTY type standard table of TS_SOLDTOPARTY .
  types:
     TS_SALESORG type TVKOT .
  types:
TT_SALESORG type standard table of TS_SALESORG .
  ...
  constants GC_SOLDTOPARTY type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'SoldToParty' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZHKMC_VMS_SEARCH_H_MPC====CP' ##NO_TEXT.

  methods DEFINE_MATERIAL
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_SOLDTOPARTY
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZHKMC_VMS_SEARCH_H_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZHKMC_VMS_SEARCH_HELP_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20230628201451'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'SoldToParty'.                            "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZHKMC_VMS_SEARCH_H_MPC=>TS_MATERIAL' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'Material' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'TVKOT'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SalesOrg' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'SoldToParty' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZHKMC_VMS_SEARCH_H_MPC=>TS_SOLDTOPARTY' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SoldToParty' ). "#EC NOTEXT
